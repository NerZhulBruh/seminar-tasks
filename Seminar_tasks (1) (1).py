...
needed_name = splitted[0].split(',')
needed_grade = splitted[1].split(',')
needed_subject = splitted[2].split(',')
needed_year = splitted[3].split(',')
print(needed_name, needed_grade, needed_subject ,needed_year)
